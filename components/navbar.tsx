      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <nav className="hidden items-center gap-2 md:flex">
            <a href="/dashboard/library" className="rounded-lg px-3 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-100 hover:text-gray-900">
              Library
            </a>
            ...
            {isAdmin && (
              <>
                ...
                <a href="/dashboard/admin/beta-requests" className="rounded-lg px-3 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-100 hover:text-gray-900">
                  Beta requests
                </a>
              </>
            )}
