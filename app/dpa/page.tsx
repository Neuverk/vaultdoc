        ...
        <div className="rounded-2xl border border-gray-200 bg-white px-10 py-12 shadow-sm">
          ...
          <Section title="1. Definitions">
            <ul className="space-y-2 text-sm text-gray-600">
              <li><span className="font-semibold text-gray-800">&ldquo;Controller&rdquo;</span> — the natural or legal person who determines the purposes and means of processing personal data (the VaultDoc customer).</li>
              <li><span className="font-semibold text-gray-800">&ldquo;Processor&rdquo;</span> — Neuverk, which processes personal data on behalf of the Controller in connection with the VaultDoc service.</li>
              <li><span className="font-semibold text-gray-800">&ldquo;Personal data&rdquo;</span> — any information relating to an identified or identifiable natural person as defined in GDPR Article 4(1).</li>
              <li><span className="font-semibold text-gray-800">&ldquo;Processing&rdquo;</span> — any operation performed on personal data as defined in GDPR Article 4(2).</li>
              <li><span className="font-semibold text-gray-800">&ldquo;Sub-processor&rdquo;</span> — any third party engaged by the Processor to carry out processing activities on behalf of the Controller.</li>
              <li><span className="font-semibold text-gray-800">&ldquo;Data breach&rdquo;</span> — a breach of security leading to accidental or unlawful destruction, loss, alteration, unauthorised disclosure of, or access to, personal data.</li>
            </ul>
          </Section>
          ...
          <Section title="4. Processor Obligations">
            ...
            <ul className="mt-2 space-y-2 text-sm text-gray-600">
              <li>— Process personal data only on documented instructions from the Controller, which include these Terms and the DPA, unless required to do so by applicable law</li>
              <li>— Ensure that persons authorised to process personal data are subject to appropriate confidentiality obligations</li>
              <li>— Implement appropriate technical and organisational measures to ensure a level of security appropriate to the risk, in accordance with GDPR Article 32</li>
              <li>— Not engage sub-processors without prior general authorisation from the Controller (which is granted by acceptance of this DPA), subject to the conditions in Section 6</li>
              <li>— Assist the Controller in responding to requests from data subjects exercising their rights under GDPR Chapter III</li>
              <li>— Assist the Controller with its obligations under GDPR Articles 32-36 (security, breach notification, DPIA)</li>
              <li>— Delete or return all personal data to the Controller at the end of the service relationship, at the Controller&apos;s choice</li>
          ...
          <Section title="6. Sub-processors">
              ...
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">Transfer basis</th>
                  </tr>
                </thead>
            ...
            <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
              <p className="font-semibold mb-1">Note regarding Anthropic</p>
              <p>
